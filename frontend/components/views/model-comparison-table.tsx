...
const COLS: { key: "accuracy" | "precision" | "recall" | "f1" | "roc_auc"; label: string }[] = [
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Métricas sobre el conjunto de prueba (mejor modelo resaltado)</CardDescription>
      </CardHeader>
