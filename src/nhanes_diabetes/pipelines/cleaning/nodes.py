...
def merge_nhanes_tables(
    ...
    # Allowlist por fuente: conserva solo las variables previstas y evita arrastrar
    # items de seguimiento de DIQ (fuga), pesos muestrales (WT*), variables de diseno
    # (SDMV*) y columnas redundantes. Si una fuente no aparece en keep_columns, se
    # conserva completa.
